...
def chect_keydown_event(event,ai_settings,screen,sb,ship,bullets,stats,aliens):
	"""响应按键"""
...
def check_events(ai_settings,screen,stats,sb,play_button,ship,bullets,aliens):
	...
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			...
			check_play_button(ai_settings,screen,stats,sb,play_button,aliens,bullets,ship,mouse_x,mouse_y)
		elif event.type == pygame.KEYDOWN:
			chect_keydown_event(event,ai_settings,screen,sb,ship,bullets,stats,aliens)	
		elif event.type == pygame.KEYUP:
			check_keyup_event(event,ship)

def check_play_button(ai_settings,screen,stats,sb,play_button,aliens,bullets,ship,mouse_x,mouse_y):
	"""玩家在单击Play按钮时开始新游戏"""
